...
export const themePalettes = {
  light: {
    ...
    borderColor: "#e1e6ed", // Crisp borders and divider lines
    bgBorder: "#c2cbd8", // Alias for borders
    ...
    textSecondary: "#2c394a", // Post descriptions, body copy, active icons
    textMuted: "#465162", // Timestamps, helper notes, placeholders
